    ...
    <template>
        <div class="flex flex-col bg-gradient-to-br from-pink-100 via-purple-200 to-indigo-200 h-full">
            <main class="flex-grow container mx-auto p-4 md:p-6 xl:max-w-6xl">
                ...
                <div v-else class="bg-white/70 rounded-xl shadow-lg mt-6 overflow-hidden">
                    <div class="flex border-b border-gray-200 bg-white/80">
                        <button @click="activeTab = 'upload'" :class="['py-4 px-6 text-sm cursor-pointer font-medium transition duration-200',
                            activeTab === 'upload' ? 'border-b-2 border-pink-500 text-pink-600' : 'text-gray-500 hover:text-gray-700']">
                            Subir Archivos
                        </button>
                        <button @click="activeTab = 'files'" :class="['py-4 px-6 text-sm cursor-pointerfont-medium transition duration-200',
                            activeTab === 'files' ? 'border-b-2 border-pink-500 text-pink-600' : 'text-gray-500 hover:text-gray-700']">
                            Mis Archivos
                        </button>
                    </div>
                    ...
                    <div v-if="activeTab === 'files'" class="p-6">
                        ...
                        <div v-else>
                            <div class="border-b border-gray-200 mb-6 flex flex-wrap">
                                <button v-for="type in fileTypes" :key="type.value" :class="['mr-6 py-2 px-3 font-medium flex items-center transition duration-200',
